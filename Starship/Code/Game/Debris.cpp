	...
	: Entity( game, startingPosition )
{
	...
	m_numOfSides = rng.RollRandomIntInRange( MIN_NUM_OF_SIDES, MAX_NUM_OF_SIDES );
...
{
    constexpr int MAX_VERTS = MAX_NUM_OF_SIDES * 3;
    Vertex tempWaspWorldVerts[MAX_VERTS];
...
{
	m_vertexArray = new Vertex[MAX_NUM_OF_SIDES * 3];

    RandomNumberGenerator rng;
    float radii[MAX_NUM_OF_SIDES];

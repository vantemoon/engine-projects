...
//-----------------------------------------------------------------------------------------------
Asteroid::Asteroid( Game* game, Vec2 const& startingPosition, float orientationDegrees, Vec2 const& startingVelocity, float startingAngularVelocity, float sizeScale )
...
void Asteroid::InitializeVertexArray()
{
	...
	// Triangle A
	m_vertexArray[0] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[1] = Vertex( vertexPos1, ASTEROID_COLOR, Vec2() );
	m_vertexArray[2] = Vertex( vertexPos2, ASTEROID_COLOR, Vec2() );

	// Triangle B
	m_vertexArray[3] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[4] = Vertex( vertexPos2, ASTEROID_COLOR, Vec2() );
	m_vertexArray[5] = Vertex( vertexPos3, ASTEROID_COLOR, Vec2() );

	// Triangle C
	m_vertexArray[6] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[7] = Vertex( vertexPos3, ASTEROID_COLOR, Vec2() );
	m_vertexArray[8] = Vertex( vertexPos4, ASTEROID_COLOR, Vec2() );

	// Triangle D
	m_vertexArray[9] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[10] = Vertex( vertexPos4, ASTEROID_COLOR, Vec2() );
	m_vertexArray[11] = Vertex( vertexPos5, ASTEROID_COLOR, Vec2() );

	// Triangle E
	m_vertexArray[12] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[13] = Vertex( vertexPos5, ASTEROID_COLOR, Vec2() );
	m_vertexArray[14] = Vertex( vertexPos6, ASTEROID_COLOR, Vec2() );

	// Triangle F
	m_vertexArray[15] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[16] = Vertex( vertexPos6, ASTEROID_COLOR, Vec2() );
	m_vertexArray[17] = Vertex( vertexPos7, ASTEROID_COLOR, Vec2() );

	// Triangle G
	m_vertexArray[18] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[19] = Vertex( vertexPos7, ASTEROID_COLOR, Vec2() );
	m_vertexArray[20] = Vertex( vertexPos8, ASTEROID_COLOR, Vec2() );

	// Triangle H
	m_vertexArray[21] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[22] = Vertex( vertexPos8, ASTEROID_COLOR, Vec2() );
	m_vertexArray[23] = Vertex( vertexPos9, ASTEROID_COLOR, Vec2() );

	// Triangle I
	m_vertexArray[24] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[25] = Vertex( vertexPos9, ASTEROID_COLOR, Vec2() );
	m_vertexArray[26] = Vertex( vertexPos10, ASTEROID_COLOR, Vec2() );

	// Triangle J
	m_vertexArray[27] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[28] = Vertex( vertexPos10, ASTEROID_COLOR, Vec2() );
	m_vertexArray[29] = Vertex( vertexPos11, ASTEROID_COLOR, Vec2() );

	// Triangle K
	m_vertexArray[30] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[31] = Vertex( vertexPos11, ASTEROID_COLOR, Vec2() );
	m_vertexArray[32] = Vertex( vertexPos12, ASTEROID_COLOR, Vec2() );

	// Triangle L
	m_vertexArray[33] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[34] = Vertex( vertexPos12, ASTEROID_COLOR, Vec2() );
	m_vertexArray[35] = Vertex( vertexPos13, ASTEROID_COLOR, Vec2() );

	// Triangle M
	m_vertexArray[36] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[37] = Vertex( vertexPos13, ASTEROID_COLOR, Vec2() );
	m_vertexArray[38] = Vertex( vertexPos14, ASTEROID_COLOR, Vec2() );

	// Triangle N
	m_vertexArray[39] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[40] = Vertex( vertexPos14, ASTEROID_COLOR, Vec2() );
	m_vertexArray[41] = Vertex( vertexPos15, ASTEROID_COLOR, Vec2() );

	// Triangle O
	m_vertexArray[42] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[43] = Vertex( vertexPos15, ASTEROID_COLOR, Vec2() );
	m_vertexArray[44] = Vertex( vertexPos16, ASTEROID_COLOR, Vec2() );

	// Triangle P
	m_vertexArray[45] = Vertex( Vec3( 0.f, 0.f, 0 ), ASTEROID_COLOR, Vec2() );
	m_vertexArray[46] = Vertex( vertexPos16, ASTEROID_COLOR, Vec2() );
	m_vertexArray[47] = Vertex( vertexPos1, ASTEROID_COLOR, Vec2() );
}
...
void Asteroid::Die()
{
	...
	m_game->SpawnDebrisCluster( 12, m_position, m_velocity, ASTEROID_COLOR, m_cosmeticRadius * 0.2f, m_cosmeticRadius * 0.8f );

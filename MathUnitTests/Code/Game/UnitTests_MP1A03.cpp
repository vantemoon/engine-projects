//-----------------------------------------------------------------------------------------------
// UnitTests_MP1A03.cpp
//
#include "Game/UnitTests_MP1A03.hpp"
#include <stdio.h>
#include <stdlib.h>
...
#if defined( ENABLE_TestSet_MP1A03_AABB2Basics )
//-----------------------------------------------------------------------------------------------
...
#if defined( ENABLE_TestSet_MP1A03_IntVec2Basics )
//-----------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_AABB2Basics()
{
#if defined( ENABLE_TestSet_MP1A03_AABB2Basics )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_AABB2Methods()
{
#if defined( ENABLE_TestSet_MP1A03_AABB2Methods )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_IntVec2Basics()
{
#if defined( ENABLE_TestSet_MP1A03_IntVec2Basics )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_IntVec2Methods()
{
#if defined( ENABLE_TestSet_MP1A03_IntVec2Methods )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_LerpAndClamp()
{
#if defined( ENABLE_TestSet_MP1A03_LerpAndClamp )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_Turning2D()
{
#if defined( ENABLE_TestSet_MP1A03_Turning2D )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A03_DotProduct2D()
{
#if defined( ENABLE_TestSet_MP1A03_DotProduct2D )
...
{
	RunTestSet( true, TestSet_MP1A03_AABB2Basics,		"MP1-A03: AABB2 Basics" );
	RunTestSet( true, TestSet_MP1A03_AABB2Methods,		"MP1-A03: AABB2 Methods" );
	RunTestSet( true, TestSet_MP1A03_IntVec2Basics,		"MP1-A03: IntVec2 Basics" );
	RunTestSet( true, TestSet_MP1A03_IntVec2Methods,	"MP1-A03: IntVec2 Methods" );
	RunTestSet( true, TestSet_MP1A03_LerpAndClamp,		"MP1-A03: Lerping & Clamping" );
	RunTestSet( true, TestSet_MP1A03_Turning2D,			"MP1-A03: Turning" );
	RunTestSet( true, TestSet_MP1A03_DotProduct2D,		"MP1-A03: 2D Dot Product" );
}

//-----------------------------------------------------------------------------------------------
// UnitTests_MP1A07.cpp
//
#include "Game/UnitTests_MP1A07.hpp"
#include <stdio.h>
#include <stdlib.h>
...
#if defined( ENABLE_TestSet_MP1A07_MatrixConstruction ) // Suppress these until Vec4 & Mat44 exist
//-----------------------------------------------------------------------------------------------
...
#endif // ENABLE_TestSet_MP1A07_MatrixConstruction
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A07_MatrixConstruction()
{
#if defined( ENABLE_TestSet_MP1A07_MatrixConstruction )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A07_MatrixStaticCreates()
{
#if defined( ENABLE_TestSet_MP1A07_MatrixStaticCreates )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A07_MatrixAccessors()
{
#if defined( ENABLE_TestSet_MP1A07_MatrixAccessors )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A07_MatrixMutators()
{
#if defined( ENABLE_TestSet_MP1A07_MatrixMutators )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A07_MatrixAppends()
{
#if defined( ENABLE_TestSet_MP1A07_MatrixAppends )
...
//-----------------------------------------------------------------------------------------------
int TestSet_MP1A07_MatrixTransforms()
{
#if defined( ENABLE_TestSet_MP1A07_MatrixTransforms )
...
{
// 	printf( "(MP1-A05 and MP1-A06 have no unit tests.)\n" );
// 	printf( "Running tests for MP1-A07 (version 1)...\n" );
	RunTestSet( true, TestSet_MP1A07_MatrixConstruction,	"MP1-A07: Matrix44 Construction" );
	RunTestSet( true, TestSet_MP1A07_MatrixStaticCreates,	"MP1-A07: Matrix44 Static Create methods" );
	RunTestSet( true, TestSet_MP1A07_MatrixAccessors,		"MP1-A07: Matrix44 Accessors (gets)" );
	RunTestSet( true, TestSet_MP1A07_MatrixMutators,		"MP1-A07: Matrix44 Mutators (sets)" );
	RunTestSet( true, TestSet_MP1A07_MatrixAppends,			"MP1-A07: Matrix44 Appends (self-transforms)" );
	RunTestSet( true, TestSet_MP1A07_MatrixTransforms,		"MP1-A07: Matrix44 Transform methods" );
}
